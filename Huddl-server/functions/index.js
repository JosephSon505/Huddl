...
// import handlers
const { helloWorld, signup, login, getUser, getAllUsers, sendSurvey, setTherapist, getRandomTherapist } = require('./handlers/user');
...
app.get('/getTherapist', getRandomTherapist);
app.post('/setTherapist', setTherapist);
